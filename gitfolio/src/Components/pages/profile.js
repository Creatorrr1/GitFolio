                    ...
                    <li className="exerciseBox" key={index}>
                      <div className="git-img-box">
                        {exercise.githubImage !== "" ? (
                          <img src={exercise.githubImage} alt="github-img" className="git-img" />
                        ) : (
                          <div>
                            <p>add image</p>
                          </div>
                      ...
                      <div className="git-url-box">
                        ...
                        {exercise.githubUrl !== "" ? (
                          <div>
                            <a href={exercise.githubUrl} className="a-url-max-size">
                              {exercise.githubUrl}
                            </a>
                        ...
                        <button
                          className="fExerciseDltBtn"
                          onClick={(event) => {
                            fExerciseDlt(event, exercise.id)
                          }}
                        >
                          Delete
                        </button>
